...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Note: Backend doesn't return role field, so we'll check email or add role check later
      // For now, allow admin@example.com to access
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-md w-full bg-white rounded-lg shadow-xl p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Visual Data Platform</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-600">
          ...
          <p className="font-mono text-xs mt-1">admin@example.com / Admin@123</p>
        </div>
      </div>
    </div>
  );
